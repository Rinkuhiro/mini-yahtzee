    ...
    return (
     <>
        ...
        <View style={styles.home}>
            ...
            :
            <>
            <Text style={styles.label}>Rules of the game</Text>
            <Text multiline="true" style={styles.rules}>THE GAME: Upper section of the classic Yahtzee 
            ...
            <Pressable style={styles.button} onPress={() => navigation.navigate('Gameboard', {playerName : playerName})}>
